...
?>
    ...
    <section class="aboutus-section spad">
        <div class="container">
            <div class="aboutus-page-text">
                ...
                <img src="<?=url("/assets/web/img/about-us.jpg")?>"alt="">
    ...
    <section class="testimonial-section set-bg spad">
        <div class="container">
            <div class="row">
                    ...
                    <div class="testimonial-slider owl-carousel">
                        <div class="ts-item">
                            ...
                            <div class="author-pic">
                                <img src="<?=url("/assets/web/img/author-pic.png")?>"alt="">
                            </div>
                        </div>
                        <div class="ts-item">
                            <div class="rating">
            ...
            <?php foreach($trainers as $trainer) { ?>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="trainer-item">
                        <div class="ti-pic">
                            <img src="<?=url("/assets/web/img/trainer/trainer-1.jpg")?>"alt="">
                            <div class="ti-links">
                            ...
                            <div class="trainer-text">
                                <h5> <?= $trainer->name; ?> <span>- <?= $trainer->specialty; ?></span></h5>
                            </div>
                        </div>
                    </div>
                </div>
