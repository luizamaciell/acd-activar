...
?>
<section class="blog-single-hero" data-setbg="<?=url("/assets/web/img/blog-single-hero.jpg")?>">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="blog-single-text">
                        ...
                        <div class="blog-pic">
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src=<?=url("/assets/web/img/blog-single-1.jpg")?> alt="">
                                </div>
                                <div class="col-lg-6">
                                    <img src=<?=url("/assets/web/img/blog-single-2.jpg")?> alt="">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <img src=<?=url("/assets/web/img/blog-single-3.jpg")?> alt="">   
                                        </div>
                                        <div class="col-sm-6">
                                            <img src=<?=url("/assets/web/img/blog-single-4.jpg")?> alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="blog-single-sidebar">
                        ...
                        <div class="bs-recent-news">
                            ...
                            <a href="#" class="br-item">
                                <div class="bi-pic">
                                    <img src=<?=url("/assets/web/img/br-recent-1.jpg")?> alt="">
                                </div>
                                <div class="bi-text">
                            ...
                            <a href="#" class="br-item">
                                <div class="bi-pic">
                                    <img src=<?=url("/assets/web/img/br-recent-2.jpg")?> alt="">
                                </div>
                                <div class="bi-text">
                                    <span>Jan 31, 2019</span>
