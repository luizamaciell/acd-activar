                ...
                <div class="col-lg-12">
                    <div class="timetable-controls">
                        <ul>
                            ...
                            <li data-tsfilter="jiu-jitsu">JIU-JITS</li>
                            <li data-tsfilter="box">Box</li>
                            <li data-tsfilter="fitDance">Fit Dance</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td></td>
                            <td class="hover-bg ts-item" data-tsmeta="jiu-jitsu">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td class="hover-bg ts-item" data-tsmeta="box">
                        ...
                        <tr>
                            ...
                            <td class="hover-bg ts-item" data-tsmeta="fitDance">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="choose-item">
                        <img src="<?=url("/assets/web/img/icons/chose-icon-1.png")?>">
                        <h5>Support 24/24</h5>
                ...
                <div class="col-lg-4">
                    <div class="choose-item">
                        <img src="<?=url("/assets/web/img/icons/chose-icon-2.png")?>">
                        <h5>Our trainer</h5>
                ...
                <div class="col-lg-4">
                    <div class="choose-item">
                        <img src="<?=url("/assets/web/img/icons/chose-icon-3.png")?>">
                ...
                <div class="col-lg-4">
                    <div class="choose-item">
                        <img src="<?=url("/assets/web/img/icons/chose-icon-4.png")?>">
                        <h5>Our equipment</h5>
                ...
                <div class="col-lg-4">
                    <div class="choose-item">
                        <img src="<?=url("/assets/web/img/icons/chose-icon-5.png")?>">
                        <h5>Classes daily</h5>
                ...
                <div class="col-lg-4">
                    <div class="choose-item">
                        <img src="<?=url("/assets/web/img/icons/chose-icon-6.png")?>">
